...
pdf("MT_per_each_population_selected.pdf",height=6,width=12)
p <- VlnPlot(obj, idents = c("Principal cell","Clear/Narrow cell","Basal cell","Halo/T cell"),features = c("percent.mt"), ncol = 1, pt.size=0, split.by = "samples")
print(p)
dev.off()
